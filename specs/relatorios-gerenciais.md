...
>
> **Não confirmado (fica para o passo 2 do plano, não travar aqui):** fonte do mapeamento ticker→Código CVM / ticker→CNPJ para qualquer ticker digitado (não só os 2 pilotos). Se nenhuma fonte gratuita e confiável for encontrada, reportar como desvio antes de prosseguir — não inventar o mapeamento.
